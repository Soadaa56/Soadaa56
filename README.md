...
6/26/25: Moving [Milknthingzz](HTTPS://milknthingzz.xyz) to Lightsail to save on costs but also maintain using AWS since many professional use AWS cloud services. My future personal projects at [kevinduffy.dev](www.kevinduffy.dev) (Not currently live), will be on linode to try other services.
Also, currently reading through [Eloquent JavaScript](https://eloquentjavascript.net/01_values.html) to make sure I'm at least a functional base level with JavaScript haha (Just learned its also known as EMCAScript).
